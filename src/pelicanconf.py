...
I18N_SUBSITES = {
    "en": {
        ...
        "LINKS": (("4Apps", "https://4apps.lv/products"),),
    }
}
...
LINKS = (
    ...
    (
        "Ko darītu savādāk",
        "http://calis.delfi.lv/forums/(tema/4014436-ko-dzivokli-un-maja-taisitu-savadak/)/",
    ),
...
# Social widget
SOCIAL = (
    ("mastodon", "https://mastodon.social/@gintsmurans"),
